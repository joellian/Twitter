...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "ZsZQ0ziPzsets4oI3Zw6kCBVq", consumerSecret: "KSbxhpuA0QRW3f3jRaKL1uzwUjufyimSAUgUN80xFFyBItkomA")
    var loginSuccess: (() -> ())?
